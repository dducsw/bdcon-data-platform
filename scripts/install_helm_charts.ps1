...
helm repo update
helm upgrade --install airflow apache-airflow/airflow --namespace $NAMESPACE --create-namespace -f ../k8s/airflow/airflow-values.yaml --wait
...
helm repo update
helm upgrade --install trino trino/trino --namespace $NAMESPACE --create-namespace -f ../k8s/trino/trino-values.yaml --wait
